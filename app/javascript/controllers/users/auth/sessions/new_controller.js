      ...
      fetch(url, init)
        ...
        .then(response => {
          if (response.process) {
            ...
            if (this.afterLogin) {
              window.open(this.afterLogin, `_self`)
            } else {
        ...
        .catch(error => {
          console.log(error)
          this.getControllerByIdentifier("app--helpers--snackbar").doSnackbar("danger", this.getControllerByIdentifier("app--shared--messages").generalError(), 2000)
        })
    }
  }
