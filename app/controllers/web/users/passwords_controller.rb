...
class Web::Users::PasswordsController < Devise::PasswordsController
  ...
  def update
    ...
    if resource.errors.empty?
      ...
      render :json => {type: "success", process: true, message: "Nova Senha salva com sucesso.", resource: resource, location: after_resetting_password_path_for(resource)}.as_json
